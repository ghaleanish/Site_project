                    ...
                    <div class="card-body p-3">
                        ...
                        <form method='POST' action="{{ route('postAddCategory') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="title" class="form-control border border-2 p-2" value="{{$category->title}}" required>
                                    @error('title')
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <img src="/site/uploads/category/{{$category->photo }}"
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea class="form-control border border-2 p-2" 
                                        placeholder=" Say something about product" id="floatingTextarea2" name="detail"
                                        rows="4" cols="50" required>{{$category->detail}}</textarea>
                                        @error('detail')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                        @enderror
                                </div>
