                    ...
                    <div class="card-body p-3">
                        ...
                        <form method='POST' action="{{ route('postAddProduct') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="category" class="form-control border border-2 p-2" value="{{$product->category}}">
                                    @error('category')
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="title" class="form-control border border-2 p-2" value="{{$product->title}}">
                                    @error('title')
                                <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="price" class="form-control border border-2 p-2" value="{{$product->price}}">
                                    @error('price')
                                <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    <img src="{{ asset('site/uploads/niche/'.$product->photo) }}"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="radio"  name="status" value="{{$product->status}}">
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea class="form-control border border-2 p-2"
                                        ...
                                        rows="4" cols="50">{{$product->detail}}</textarea>
                                        @error('detail')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                        @enderror
                                </div>
